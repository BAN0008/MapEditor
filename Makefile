...
# Template: app
# Command: /usr/bin/qmake -o Makefile MapEditor.pro
#############################################################################
...
DISTDIR = /home/brad/MapEditor-March/.tmp/MapEditor1.0.0
LINK          = g++
...
Makefile: MapEditor.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile MapEditor.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/Object.h src/MainWindow.h src/MainEditor.h $(DISTDIR)/
	$(COPY_FILE) --parents src/Main.cpp src/Object.cpp src/MainWindow.cpp src/MainEditor.cpp $(DISTDIR)/
